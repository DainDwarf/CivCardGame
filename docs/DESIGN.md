...
- **Trade route (standing rent):** pay a cost to open it into the persistent
  ...
  route** — yielding its `produces` and paying its `upkeep` rent every
