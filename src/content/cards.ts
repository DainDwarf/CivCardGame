...
export interface CardDef {
  ...
  effect?: CardEffect;
  /** Victory points (scored from the tableau, staffing-agnostic). */
  vp?: number;
...
export const CARDS: Record<string, CardDef> = {
  ...
  workshop: { id: 'workshop', name: 'Workshop', kind: 'permanent', cost: 2, produces: { production: 2 }, vp: 1, workers: 1, tags: ['building'] },
  library: { id: 'library', name: 'Library', kind: 'permanent', cost: 3, produces: { science: 2 }, vp: 1, workers: 1, tags: ['building'] },
  university: { id: 'university', name: 'University', kind: 'permanent', cost: 4, produces: { science: 3 }, vp: 2, workers: 1, tags: ['building'] },
  ...
  pyramids: { id: 'pyramids', name: 'The Pyramids', kind: 'permanent', cost: 4, produces: { production: 1 }, vp: 3, defense: 1, workers: 1, tags: ['wonder'] },
  great_library: { id: 'great_library', name: 'The Great Library', kind: 'permanent', cost: 4, produces: { science: 2 }, vp: 3, workers: 1, tags: ['wonder'] },
  colossus: { id: 'colossus', name: 'The Colossus', kind: 'permanent', cost: 4, produces: { food: 1, science: 1 }, vp: 3, defense: 1, workers: 1, tags: ['wonder'] },
